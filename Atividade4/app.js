...
//O DRAW ELEMENTS NÃO QUIS FUNCIONAR 
...
var materialAmbient = vec4(1.0 , 4.0, 0.0, 1.0);
...
function render_faces(obj, program){
    ...
    gl.uniformMatrix4fv(viewMatrixUniform, false, flatten(viewMatrix));
    gl.uniformMatrix4fv(modelMatrixUniform, false, flatten(modelMatrix));
